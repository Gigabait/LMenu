...
function GameDetails(servername, serverurl, mapname, maxplayers, steamid, gamemode)
	...
	MsgC(Color(0xAA, 0xAA, 0xFF), servername.."\n")
	MsgC(Color(0xAA, 0xAA, 0xFF), serverurl.."\n")
	MsgC(Color(0xAA, 0xAA, 0xFF), gamemode.."\n")
	MsgC(Color(0xAA, 0xAA, 0xFF), mapname.."\n")
	MsgC(Color(0xAA, 0xAA, 0xFF), maxplayers.."\n")
	MsgC(Color(0xAA, 0xAA, 0xFF), steamid.."\n")
